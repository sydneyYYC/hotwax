...
export default function Login() {
  ...
  return (
    <div className=" flex flex-col max-w-screen min-h-screen bg-baseblack bg-gradient-to-t from-baseblack to-darkred">
      <div className=" justify-self-center grid grid-cols-2 grid-rows-1 m-auto self-center p-6 max-w-max bg-darkred rounded-md justify-items-center mt-[8rem]">
      ...
      <button onClick={handleClick} className=" m-4 p-4 bg-myred  rounded-md text-white font-semibold max-w-max self-center mb-[12rem]">Connect to Spotify</button>
    </div>
  )
}
